...
const Home = () => {
  ...
  return (
    <Layout title={"ALL-BLACK-PRODUCT"}>
     <img
        src="https://thumbs.dreamstime.com/b/ecommerce-gold-text-black-background-d-rendered-royalty-free-stock-picture-image-can-be-used-online-website-banner-87910929.jpg"
        className="banner-img"
        alt="bannerimage"
        width={"100%"}
      />

      <div className="row contianer-fluid home-page bg-black" >
        <div className="col-md-4 filters" >
          <h4 className="text-center"> <span style={{color:'whitesmoke'}}><strong>Filter By Category</strong></span> </h4>
          <div className="d-flex flex-column m-3">
            {categories.map((c) => (
              <div className="m-sm-1">
                ...
                >
                 <span style={{color:'white'}} > <strong>{c.name}</strong></span>
                </Checkbox>
              </div>
            ))}
          </div>
          <h4 className="text-center"><span style={{color:'whitesmoke'}}><strong>Filter By Price</strong></span></h4>
          <div className="d-flex flex-column m-3">
            {
                ...
                {Prices.map((price) => (
                  <div className="m-sm-1">
                    <Radio key={price._id} value={price.array}>
                      <span style={{color:'white'}} > <strong>{price.name}</strong></span>
                    </Radio>
                  </div>
                ))}
              </Radio.Group>
